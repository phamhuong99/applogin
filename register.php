...
if(isset($_POST) && !empty($_POST)) {
    ...
    if(empty($errors)) {
        /**
         * nếu không có lỗi thì thực thi câu lệnh insert ào csdl
         */
        $username=$_POST["username"];
        $password=md5($_POST["password"]);//mã hóa
        $created_at = date("Y-m-d H:i:s");

        $sqlInsert = "INSERT INTO user (username,password, created_at) VALUES (?,?,?)";//tăng cường bảo mật
